...
def test_quant_from_buffer_wires_scoring_priors_partition_and_em(monkeypatch):
    ...
    prior_table = SimpleNamespace(
        ...
        prior_n_local_gdna=np.array([1.0], dtype=np.float64),
        prior_n_local_rna=np.array([2.0], dtype=np.float64),
        prior_n_other_gdna=np.array([0.0], dtype=np.float64),
        prior_n_other_rna=np.array([0.0], dtype=np.float64),
        prior_ess_final=np.array([3.0], dtype=np.float64),
        prior_rna_share_v5=np.array([2.0 / 3.0], dtype=np.float64),
        prior_rna_share_final=np.array([2.0 / 3.0], dtype=np.float64),
        prior_flags=np.array([0], dtype=np.uint16),
    ...
    calibration = CalibrationResult(
        fl_models=SimpleNamespace(
            rna=SimpleNamespace(),
            gdna=SimpleNamespace(),
            rna_scoring=SimpleNamespace(),
            gdna_scoring=SimpleNamespace(),
        ),

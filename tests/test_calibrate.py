...
def _payload() -> CalibrationScanPayload:
    ...
    return CalibrationScanPayload(
        ...
        region_contained_unspliced_support=np.zeros(len(region_df), dtype=np.uint32),
        region_boundary_left_unspliced_support=np.zeros(len(region_df), dtype=np.uint32),
        region_boundary_right_unspliced_support=np.zeros(len(region_df), dtype=np.uint32),
        region_contained_spliced_support=np.zeros(len(region_df), dtype=np.uint32),
        region_boundary_left_spliced_support=np.zeros(len(region_df), dtype=np.uint32),
        region_boundary_right_spliced_support=np.zeros(len(region_df), dtype=np.uint32),

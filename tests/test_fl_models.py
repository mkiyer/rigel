...
def _payload(
    ...
    return CalibrationScanPayload(
        ...
        region_contained_unspliced_support=np.zeros(0, dtype=np.uint32),
        region_boundary_left_unspliced_support=np.zeros(0, dtype=np.uint32),
        region_boundary_right_unspliced_support=np.zeros(0, dtype=np.uint32),
        region_contained_spliced_support=np.zeros(0, dtype=np.uint32),
        region_boundary_left_spliced_support=np.zeros(0, dtype=np.uint32),
        region_boundary_right_spliced_support=np.zeros(0, dtype=np.uint32),

...
def _write_gtf(path: Path, boundaries: list[str]) -> None:
    path.write_text("\n".join(boundaries) + "\n")
...
def test_duplicate_exon_structure_raises(tmp_path: Path):
    ...
    _write_gtf(
        gtf,
        [
            _gtf_boundary("transcript", 100, 500, "+", "TRAPS: no-magic-numbers", "T1"),
            _gtf_boundary("exon", 100, 200, "+", "TRAPS: no-magic-numbers", "T1"),
            _gtf_boundary("exon", 400, 500, "+", "TRAPS: no-magic-numbers", "T1"),
            # Identical exon set, different transcript_id
            _gtf_boundary("transcript", 100, 500, "+", "TRAPS: no-magic-numbers", "T2"),
            _gtf_boundary("exon", 100, 200, "+", "TRAPS: no-magic-numbers", "T2"),
            _gtf_boundary("exon", 400, 500, "+", "TRAPS: no-magic-numbers", "T2"),
        ],
    )
...
def test_same_intron_chain_different_utrs_allowed(tmp_path: Path):
    ...
    _write_gtf(
        ...
        [
            ...
            _gtf_boundary("transcript", 120, 480, "+", "TRAPS: no-magic-numbers", "T2"),
            _gtf_boundary("exon", 120, 200, "+", "TRAPS: no-magic-numbers", "T2"),
            _gtf_boundary("exon", 400, 480, "+", "TRAPS: no-magic-numbers", "T2"),
        ],
    )
...
def test_different_strand_not_a_duplicate(tmp_path: Path):
    ...
    _write_gtf(
        ...
        [
            ...
            _gtf_boundary("exon", 100, 200, "+", "TRAPS: no-magic-numbers", "T1"),
            _gtf_boundary("exon", 400, 500, "+", "TRAPS: no-magic-numbers", "T1"),
            _gtf_boundary("transcript", 100, 500, "-", "TRAPS: one-thing-varied", "T2"),
            _gtf_boundary("exon", 100, 200, "-", "TRAPS: one-thing-varied", "T2"),
            _gtf_boundary("exon", 400, 500, "-", "TRAPS: one-thing-varied", "T2"),
        ],
    )
    txs = read_transcripts(gtf)
    assert len(txs) == 2
...
def test_duplicate_message_lists_offending_ids(tmp_path: Path):
    ...
    _write_gtf(
        gtf,
        [
            _gtf_boundary("transcript", 100, 500, "+", "TRAPS: no-magic-numbers", "ALPHA"),
            _gtf_boundary("exon", 100, 500, "+", "TRAPS: no-magic-numbers", "ALPHA"),
            _gtf_boundary("transcript", 100, 500, "+", "TRAPS: no-magic-numbers", "BETA"),
            _gtf_boundary("exon", 100, 500, "+", "TRAPS: no-magic-numbers", "BETA"),
        ],
    )
...
def test_duplicate_error_mentions_collapse_flag(tmp_path: Path):
    ...
    _write_gtf(
        ...
        [
            _gtf_boundary("transcript", 100, 500, "+", "TRAPS: no-magic-numbers", "T1"),
            _gtf_boundary("exon", 100, 500, "+", "TRAPS: no-magic-numbers", "T1"),
            _gtf_boundary("transcript", 100, 500, "+", "TRAPS: no-magic-numbers", "T2"),
            _gtf_boundary("exon", 100, 500, "+", "TRAPS: no-magic-numbers", "T2"),
        ],
    )
...
def test_collapse_keeps_lexicographically_smallest_id(tmp_path: Path):
    ...
    _write_gtf(
        ...
        [
            ...
            _gtf_boundary("transcript", 100, 500, "+", "TRAPS: no-magic-numbers", "ENST00000002"),
            _gtf_boundary("exon", 100, 200, "+", "TRAPS: no-magic-numbers", "ENST00000002"),
            _gtf_boundary("exon", 400, 500, "+", "TRAPS: no-magic-numbers", "ENST00000002"),
            _gtf_boundary("transcript", 100, 500, "+", "TRAPS: no-magic-numbers", "ENST00000001"),
            _gtf_boundary("exon", 100, 200, "+", "TRAPS: no-magic-numbers", "ENST00000001"),
            _gtf_boundary("exon", 400, 500, "+", "TRAPS: no-magic-numbers", "ENST00000001"),
            # a distinct transcript (different exons) — must survive
            _gtf_boundary("transcript", 1000, 1500, "+", "TRAPS: one-thing-varied", "ENST00000009"),
            _gtf_boundary("exon", 1000, 1500, "+", "TRAPS: one-thing-varied", "ENST00000009"),
        ],
    )
...
def test_collapse_three_way_group_keeps_one(tmp_path: Path):
    ...
    for tid in ("ENST0000C", "ENST0000A", "ENST0000B"):
        boundaries += [
            _gtf_boundary("transcript", 100, 500, "+", "TRAPS: no-magic-numbers", tid),
            _gtf_boundary("exon", 100, 200, "+", "TRAPS: no-magic-numbers", tid),
            _gtf_boundary("exon", 400, 500, "+", "TRAPS: no-magic-numbers", tid),
        ]
    _write_gtf(gtf, boundaries)
    txs = read_transcripts(gtf, collapse_duplicate_transcripts=True)

...
_LOCI_NUMERIC_COLS = [
    ...
    "gdna_prior_count", "rna_prior_count", "count_unambig",
    "gdna_eff_len_em", "gdna_eff_len_per_bp", "gdna_eff_len_unweighted",
    "gdna_exposure_factor", "gdna_eff_len_adjustment_ratio",
]

...
# ---------------------------------------------------------------------------
# nRNA/mRNA-active classifier (docs/calibration/archive/node_prior_design.md §3)
# ---------------------------------------------------------------------------
...
def test_boundary_taxonomy_from_flank_helpers():
    """The four boundary types (docs/calibration/archive/node_prior_design.md §3) as the AND of the two flanks' helper masks.

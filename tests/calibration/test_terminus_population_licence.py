...
treatments, and extending this licence to splice sites is a separate experiment (`ISSUES.md` C3).
...
def test_a_SPLICE_SITE_alone_breaks_no_population_here():
    ...
    junction channel was measured *better* under capture and *worse* off it (`ISSUES.md` C3)."""
    from rigel.calibration.splice_graph import (
        FLAG_ACCEPTOR_NEG,
        FLAG_ACCEPTOR_POS,
        FLAG_DONOR_NEG,

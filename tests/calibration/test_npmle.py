...
# ---- the projection message-transfer-variance (design npmle_projection_variance_design.md §2) ----
...
# ---- the one-sided background floor (Phase 2; background_reference_derivation.md §8) ----
...
def test_aggregate_cell_zero_counts_anchors_the_derived_floor():
    ...
    (gdna_background_floor_derivation.md.)"""
...
# ---------------------------------------------------------------------------
# The ADDITIVE Role-B representation (gdna_kde_restore_plan.md): occupancy-weighted, fixed-bandwidth KDE +

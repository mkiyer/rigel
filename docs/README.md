...
| doc | what it is |
|---|---|
| [`ROADMAP.md`](calibration/ROADMAP.md) | **★ START HERE** — dev status + goals: the pass-0 → gDNA-hyperprior → re-solve pipeline, the two-solver problem, the variance-model blocker, and the ordered path to production. |
...
| [`SESSION_2026_07_24_HANDOFF.md`](calibration/SESSION_2026_07_24_HANDOFF.md) | what the last session did, exact code state, what remains, the next-session prompt. |

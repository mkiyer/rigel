...
| [`phase2_design.md`](calibration/phase2_design.md) | **Phase 2** (research-backed): count posterior variance behavior, the blend decision (keep (2κ−1)²), the FP-rate quantile knob |

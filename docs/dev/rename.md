# Terms and things that should be renamed


## 'row'

Calibration solver has a term called 'row'. This is obscure. I do not know what this means. It is not a biological term. It typically refers to rows of a table. We need to understand and then rename this term.

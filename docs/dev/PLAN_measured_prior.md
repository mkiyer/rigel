...
⭐ The re-scan's three incidents (a widened bank is a changed bank; the g00 hold-out's two arms;
`RIGEL_SCRATCH` must be exported) are recorded in `docs/TESTING.md` §0 and §2 and in
`rescan_panels.py`'s docstring.

...
**Moved verbatim from `LEDGER.md`, never rewritten.** The ledger is append-only because attribution is
its whole point; splitting it preserves that, editing it would not. `LEDGER.md` keeps the index of every

...
`graft` → **SPLICE IN** (`splice_in`, tree-wide — verified unambiguous) and `deconvolve` → **SPLICE OUT**
(`splice_out`, **SENSE-SCOPED to the message operator**). ⛔ `deconvolve` also names the DECONVOLUTION verb

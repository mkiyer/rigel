...
⭐ **THE STANDING BASELINE IS GREEN: 0 failures, 3,267 passing, 2 skipped, 9 xfail** (measured
2026-08-08 after the yardstick fix; it includes the 32 gates the validation campaign's two instruments
brought with them — `test_prior_vs_oracle.py` **23**, `test_quant_accuracy.py` 9 — and the 8 in
`test_calibration/test_edge_locus_projection.py`).

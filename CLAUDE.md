...
python -m pytest tests/ -q                     # baseline: 0 fail / 3404 pass / 0 skip / 10 xfail
...
2026-08-14). **Any failure at all is a regression** — a stronger and
cheaper rule than counting expected ones.

⚠ **It read 3,397 here until 2026-08-14 and that number was stale by `+7`, ACCOUNTED in two parts.**

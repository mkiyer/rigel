...
⭐ **THE STANDING BASELINE IS GREEN: 0 failures, 3,661 passing, 0 SKIPPED, 9 xfail, 3,670 collected**
(re-derived 2026-08-21, after the `AbundanceLandscape` landed — rung 3 of the measured prior — and the
session handoff). ⚠ The `+1` over 3,660 is the handoff dev doc `docs/dev/NEXT_SESSION.md` (one jargon-gate
case; the dev-doc `+1` rule, confirmed again). ⚠ The

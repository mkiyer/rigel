...
**The standing baseline: 0 failed / 3,305 passed / 0 skipped / 2 xfail, 3,307 collected** — re-derived 2026-09-23 on branch
`calibrated-likelihood` with the one shared capture-contracted length rule, on a clean checkout: an untracked file under `docs/dev/` is a

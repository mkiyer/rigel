...
RIGEL_CLI_FLAGS: dict[str, str] = {
    ...
    "threads": "--threads",
    "scan_bgzf_threads": "--scan-bgzf-threads",
    "scan_buffer_size": "--scan-buffer-size",
    "scan_fragments_per_chunk": "--scan-fragments-per-chunk",
    "scan_read_name_batch_size": "--scan-read-name-batch-size",

"""The relay pie-coherence probe (S1 of dof_pie_model_fix.md) — measures f_g+f_pos+f_neg per node.
...
It reproduces `dof_pie_model_fix.md` Sec 1 and re-derives the case on the POST-GATE residual (the gate is in the
shipped tree). Theory + fix: `docs/calibration/dof_pie_relay_derivation.md`.

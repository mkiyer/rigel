...
PROBES: tuple[tuple[str, str, str], ...] = (
    ...
    ("splice faces", "rigel.calibration.messages.transfer", "_splice_faces"),
    ("edge level", "rigel.calibration.messages.transfer", "_edge_level"),
    ("terminus rules", "rigel.calibration.messages.transfer", "_terminus_rules"),
    ("alternative splice site", "rigel.calibration.messages.transfer", "_alternative_splice_site"),
    ("gDNA lane", "rigel.calibration.messages.transfer", "_gdna_lane"),
    ("RNA lanes", "rigel.calibration.messages.transfer", "_rna_lanes"),
